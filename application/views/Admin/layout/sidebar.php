    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="<?= ($this->uri->segment(2) == 'admindashboard') ? 'active' : '' ?>">
                <a href="<?=site_url('admin/admindashboard')?>"><i class="feather icon-home"></i><span class="menu-title" data-i18n="Dashboard">Dashboard</span>
                </a>
            </li>
            ...
            <li class="<?= ($this->uri->segment(2) == 'mappoint') ? 'has-sub sidebar-group-active open' : ''?>">
                <a href="<?= site_url('admin/mappoint') ?>"><i class="feather icon-map"></i><span class="menu-title" data-i18n="Campaign">Map</span></a>
                <ul class="menu-content">
